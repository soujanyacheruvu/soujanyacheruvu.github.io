  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="mx-4" href="/projects" title="Work" />
      </nav>
      </div>
    {
      isOpen ? 
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/projects" title="Work" />
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/articles" title="Blog" />
      </nav>
      </motion.div>
